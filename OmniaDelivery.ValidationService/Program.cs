            ...
            var hostBuilder = new HostBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddTransient<IMessageHandler>((svc) =>
                    {
                        ...
                        return new RabbitMQConsumer(rabbitMQHost, rabbitMQUserName, rabbitMQPassword, "delivery.kla0102.direct", "validation.json.kla0102", ""); ;
                    });
                    ...
                    services.AddHostedService<ValidationManager>();
